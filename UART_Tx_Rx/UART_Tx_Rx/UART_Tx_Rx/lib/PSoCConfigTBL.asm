...
;  Global Register values Bank 0
	...
	mov	reg[b5h], 10h		; Row_0_OutputDrive_0 register (RDI0SRO0)
...
;       Instance name UART, Block Name RX(DCB03)
	...
	mov	reg[2eh], 45h		;UART_RX_OUTPUT_REG (DCB03OU)
;       Instance name UART, Block Name TX(DCB02)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[00h], 82h		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], 7dh		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], 5dh		; Port_0_DriveMode_2 register (PRT0DM2)
	mov	reg[02h], a2h		; Port_0_GlobalSelect register (PRT0GS)
	M8C_SetBank1
