...
;       Instance name Timer32_1, Block Name TIMER32_ISB1(DBB11)
	db		37h, 00h		;Timer32_1_CONTROL_ISB1_REG(DBB11CR0)
	db		35h, 8ch		;Timer32_1_PERIOD_ISB1_REG(DBB11DR1)
	db		36h, 46h		;Timer32_1_COMPARE_ISB1_REG(DBB11DR2)
;       Instance name Timer32_1, Block Name TIMER32_ISB2(DCB12)
	db		3bh, 00h		;Timer32_1_CONTROL_ISB2_REG(DCB12CR0)
	db		39h, 86h		;Timer32_1_PERIOD_ISB2_REG(DCB12DR1)
	db		3ah, c3h		;Timer32_1_COMPARE_ISB2_REG(DCB12DR2)
;       Instance name Timer32_1, Block Name TIMER32_LSB(DBB10)
	db		33h, 00h		;Timer32_1_CONTROL_LSB_REG(DBB10CR0)
	db		31h, 00h		;Timer32_1_PERIOD_LSB_REG(DBB10DR1)
	db		32h, 00h		;Timer32_1_COMPARE_LSB_REG(DBB10DR2)
;       Instance name Timer32_1, Block Name TIMER32_MSB(DCB13)
	db		3fh, 04h		;Timer32_1_CONTROL_MSB_REG(DCB13CR0)
	db		3dh, 47h		;Timer32_1_PERIOD_MSB_REG(DCB13DR1)
	db		3eh, 23h		;Timer32_1_COMPARE_MSB_REG(DCB13DR2)
...
;  Instance name Timer32_1, User Module Timer32
;       Instance name Timer32_1, Block Name TIMER32_ISB1(DBB11)
	db		34h, 00h		;Timer32_1_FUNC_ISB1_REG(DBB11FN)
	db		35h, 31h		;Timer32_1_INPUT_ISB1_REG(DBB11IN)
	db		36h, c0h		;Timer32_1_OUTPUT_ISB1_REG(DBB11OU)
;       Instance name Timer32_1, Block Name TIMER32_ISB2(DCB12)
	db		38h, 00h		;Timer32_1_FUNC_ISB2_REG(DCB12FN)
	db		39h, 31h		;Timer32_1_INPUT_ISB2_REG(DCB12IN)
	db		3ah, c0h		;Timer32_1_OUTPUT_ISB2_REG(DCB12OU)
;       Instance name Timer32_1, Block Name TIMER32_LSB(DBB10)
	db		30h, 00h		;Timer32_1_FUNC_LSB_REG(DBB10FN)
	db		31h, 01h		;Timer32_1_INPUT_LSB_REG(DBB10IN)
	db		32h, c0h		;Timer32_1_OUTPUT_LSB_REG(DBB10OU)
;       Instance name Timer32_1, Block Name TIMER32_MSB(DCB13)
	db		3ch, 20h		;Timer32_1_FUNC_MSB_REG(DCB13FN)
	db		3dh, 31h		;Timer32_1_INPUT_MSB_REG(DCB13IN)
	db		3eh, c0h		;Timer32_1_OUTPUT_MSB_REG(DCB13OU)
;  Instance name UART, User Module UART
;       Instance name UART, Block Name RX(DCB23)
	db		4ch, 05h		;UART_RX_FUNC_REG   (DCB23FN)
	db		4dh, c1h		;UART_RX_INPUT_REG  (DCB23IN)
	db		4eh, 40h		;UART_RX_OUTPUT_REG (DCB23OU)
;       Instance name UART, Block Name TX(DCB22)
	db		48h, 0dh		;UART_TX_FUNC_REG   (DCB22FN)
	db		49h, 01h		;UART_TX_INPUT_REG  (DCB22IN)
	db		4ah, 45h		;UART_TX_OUTPUT_REG (DCB22OU)
...
;  Ordered Global Register values
	...
	M8C_SetBank1
	mov	reg[00h], 22h		; Port_0_DriveMode_0 register (PRT0DM0)
	mov	reg[01h], ddh		; Port_0_DriveMode_1 register (PRT0DM1)
	M8C_SetBank0
	mov	reg[03h], cdh		; Port_0_DriveMode_2 register (PRT0DM2)
	mov	reg[02h], 32h		; Port_0_GlobalSelect register (PRT0GS)
	M8C_SetBank1
