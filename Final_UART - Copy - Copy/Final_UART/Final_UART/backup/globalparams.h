...
#define PORT_0_GLOBAL_SELECT   0x32    //Port 0 global select register (PRT0GS)
#define PORT_0_DRIVE_0         0x22    //Port 0 drive mode 0 register (PRT0DM0)
#define PORT_0_DRIVE_1         0xdd    //Port 0 drive mode 1 register (PRT0DM1)
#define PORT_0_DRIVE_2         0xcd    //Port 0 drive mode 1 register (PRT0DM2)
