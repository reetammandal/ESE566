...
export LoadConfig_example_adc_lcd
export _LoadConfig_example_adc_lcd
...
_LoadConfigInit:
 LoadConfigInit:
	...
	lcall	LoadConfig_example_adc_lcd
	lcall	LoadConfigTBL_example_adc_lcd_Ordered
...
;---------------------------------------------------------------------------
; Load Configuration example_adc_lcd
;
;    Load configuration registers for example_adc_lcd.
...
;               CUR_PP
;
_LoadConfig_example_adc_lcd:
 LoadConfig_example_adc_lcd:
    RAM_PROLOGUE RAM_USE_CLASS_4
    ...
    asr     a                       ; Store in carry flag
                                    ; Load bank 0 table:
    mov     A, >LoadConfigTBL_example_adc_lcd_Bank0
    mov     X, <LoadConfigTBL_example_adc_lcd_Bank0
    lcall   LoadConfig              ; Load the bank 0 values

    mov     a, 1                    ; Specify bank 1
    asr     a                       ; Store in carry flag
                                    ; Load bank 1 table:
    mov     A, >LoadConfigTBL_example_adc_lcd_Bank1
    mov     X, <LoadConfigTBL_example_adc_lcd_Bank1
